...
const NavbarLinks = () => {
  return (
    <ul className="flex lg:flex-row flex-col gap-6 text-white font-bold lg:relative text-center left-[50%] -translate-x-[50%] lg:text-md text-xl bg-cyan-800/60 backdrop-blur-lg lg:bg-amber-950 w-full py-4">
